...
* Consult the “Stan Language Manual” (linked to in the *Stan Documentation_*) for an example of a complete Stan program with a system definition and solver call.
